...
<body>
    ...
    <div class="container"> 
        ...
        <div class="alert alert-warning" id="response" style="">
        ...
        <div id="signupbox" style="display:none; margin-top:50px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2"">
            <div class="alert alert-warning" id="response1" style="">
                <strong>Warning!</strong>
            </div>
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <div class="panel-title">Sign Up</div>
                            <div style="float:right; font-size: 85%; position: relative; top:-10px"><a id="signinlink" onclick="$('#signupbox').hide(); $('#loginbox').show();$('#response1').hide();">Sign In</a></div>
                        </div>  
                        <div class="panel-body" >
                            <form id="signupform" class="form-horizontal" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="password" class="form-control" id="confpassword" name="icode" placeholder="" required>
                                    </div>
                                </div>
