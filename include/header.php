				...
				<div class="dropdown">
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						<!-- <span class="user-icon"><i class="fa fa-user-o"></i></span> -->
						 <img class="user-avatar rounded-circle" src="vendors/images/photo2.jpg" style="width:32px;">
					...
					<div class="dropdown-menu dropdown-menu-right">
						...
						<a class="dropdown-item" href="controller/logout.php"><i class="fa fa-sign-out" aria-hidden="true"></i> Log Out</a>
					</div>
				</div>
			</div>
			<!--Noti fication section-->
		</div>
	</div>
